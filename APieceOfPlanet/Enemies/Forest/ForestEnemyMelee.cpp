...
AForestEnemyMelee::AForestEnemyMelee()
	: m_Mesh{}
	, m_HealthPickup{}
	, m_ResearchPickup{}
	, m_BombDrop{}
...
void AForestEnemyMelee::BeginPlay()
{
	Super::BeginPlay();
...
void AForestEnemyMelee::SetDamageMultiplier(float multiplier)
{
	m_DamageMultiplier = multiplier;
	m_Damage *= m_DamageMultiplier;
}

void AForestEnemyMelee::SetHealthMultiplier(float multiplier)
{
...
float AForestEnemyMelee::GetMaxHealth_Implementation() const
{
	return m_MaxHealth;
}

float AForestEnemyMelee::GetCurrentHealth_Implementation() const
{
	return m_CurrentHealth;
}

bool AForestEnemyMelee::IsMelee_Implementation() const
{
	return true;
}

bool AForestEnemyMelee::IsAttacking_Implementation() const
{
	return m_IsAttacking;
}

void AForestEnemyMelee::SetIsAttacking_Implementation(bool isAttacking)
{
	m_IsAttacking = isAttacking;
}

void AForestEnemyMelee::DestroyEnemy_Implementation()
{
	UDelegates::ENEMY_DIED_NOTIFY.ExecuteIfBound();
	Destroy();
}

void AForestEnemyMelee::DropItem_Implementation() const
{
...
void AForestEnemyMelee::Attack(float dt)
{
...
float AForestEnemyMelee::TakeDamage
	(
		float DamageAmount,
...
void AForestEnemyMelee::MoveToPlayer()
{
...
void AForestEnemyMelee::MoveToCamp(bool fullSpeed)
{
...
void AForestEnemyMelee::Tick(float DeltaTime)
{
...
void AForestEnemyMelee::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
