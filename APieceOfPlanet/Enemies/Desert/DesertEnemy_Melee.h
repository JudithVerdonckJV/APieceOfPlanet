...
#include "DesertEnemy_Melee.generated.h"

class USkeletalMeshComponent;

UCLASS()
class APIECEOFPLANET_API ADesertEnemy_Melee : public APawn, public IBaseEnemy_Interface
{
	GENERATED_BODY()
...
public:
	...
	float GetDamage_Implementation() const override { return m_Damage; };
