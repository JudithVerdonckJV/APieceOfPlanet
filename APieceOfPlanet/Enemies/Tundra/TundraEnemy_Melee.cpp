...
ATundraEnemy_Melee::ATundraEnemy_Melee()
	: m_Mesh{}
	, m_HealthPickup{}
	, m_ResearchPickup{}
	, m_BombDrop{}
...
void ATundraEnemy_Melee::BeginPlay()
{
	Super::BeginPlay();
...
void ATundraEnemy_Melee::SetDamageMultiplier(float multiplier)
{
	m_DamageMultiplier = multiplier;
	m_Damage *= m_DamageMultiplier;
}

void ATundraEnemy_Melee::SetHealthMultiplier(float multiplier)
{
...
float ATundraEnemy_Melee::GetMaxHealth_Implementation() const
{
	return m_MaxHealth;
}

float ATundraEnemy_Melee::GetCurrentHealth_Implementation() const
{
	return m_CurrentHealth;
}

bool ATundraEnemy_Melee::IsMelee_Implementation() const
{
	return true;
}

bool ATundraEnemy_Melee::IsAttacking_Implementation() const
{
	return m_IsAttacking;
}

void ATundraEnemy_Melee::SetIsAttacking_Implementation(bool isAttacking)
{
	m_IsAttacking = isAttacking;
}

void ATundraEnemy_Melee::DestroyEnemy_Implementation()
{
	UDelegates::ENEMY_DIED_NOTIFY.ExecuteIfBound();
	Destroy();
}

void ATundraEnemy_Melee::DropItem_Implementation() const
{
...
void ATundraEnemy_Melee::Attack(float dt)
{
...
float ATundraEnemy_Melee::TakeDamage
(
	float DamageAmount,
...
void ATundraEnemy_Melee::MoveToPlayer()
{
...
void ATundraEnemy_Melee::MoveToCamp(bool fullSpeed)
{
...
void ATundraEnemy_Melee::Tick(float DeltaTime)
{
...
void ATundraEnemy_Melee::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
