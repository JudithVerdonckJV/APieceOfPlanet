...
ATundraEnemy_Ranged::ATundraEnemy_Ranged()
	: m_Mesh{}
	, m_HealthPickup{}
	, m_ResearchPickup{}
	, m_BombDrop{}
...
void ATundraEnemy_Ranged::BeginPlay()
{
	Super::BeginPlay();
...
void ATundraEnemy_Ranged::SetDamageMultiplier(float multiplier)
{
	m_DamageMultiplier = multiplier;
	m_Damage *= m_DamageMultiplier;
}

void ATundraEnemy_Ranged::SetHealthMultiplier(float multiplier)
{
...
float ATundraEnemy_Ranged::GetMaxHealth_Implementation() const
{
	return m_MaxHealth;
}

float ATundraEnemy_Ranged::GetCurrentHealth_Implementation() const
{
	return m_CurrentHealth;
}

bool ATundraEnemy_Ranged::IsMelee_Implementation() const
{
	return false;
}

bool ATundraEnemy_Ranged::IsAttacking_Implementation() const
{
	return m_IsAttacking;
}

void ATundraEnemy_Ranged::SetIsAttacking_Implementation(bool isAttacking)
{
	m_IsAttacking = isAttacking;
}

void ATundraEnemy_Ranged::DestroyEnemy_Implementation()
{
	UDelegates::ENEMY_DIED_NOTIFY.ExecuteIfBound();
	Destroy();
}

float ATundraEnemy_Ranged::GetDamage_Implementation() const
{
	return m_Damage;
}

void ATundraEnemy_Ranged::DropItem_Implementation() const
{
...
void ATundraEnemy_Ranged::Attack(float dt)
{
...
float ATundraEnemy_Ranged::TakeDamage
(
	float DamageAmount,
...
void ATundraEnemy_Ranged::MoveToPlayer()
{
...
void ATundraEnemy_Ranged::MoveToCamp(bool fullSpeed)
{
...
void ATundraEnemy_Ranged::Tick(float DeltaTime)
{
...
void ATundraEnemy_Ranged::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
